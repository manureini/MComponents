namespace MComponents.MToaster
{
    ...
    {
        /// <summary>
        /// The main toast class. Defaults to <see cref="ToasterDefaults.Classes.Toast"/>
        /// </summary>
        public string ToastClass { get; set; } = ToasterDefaults.Classes.Toast;
        ...
        /// <summary>
        /// The css class for the title. Defaults to <see cref="ToasterDefaults.Classes.ToastTitle"/>.
        /// </summary>
        public string ToastTitleClass { get; set; } = ToasterDefaults.Classes.ToastTitle;

        /// <summary>
        /// The css class for the message. Defaults to <see cref="ToasterDefaults.Classes.ToastMessage"/>.
        /// </summary>
        public string ToastMessageClass { get; set; } = ToasterDefaults.Classes.ToastMessage;
        ...
        /// <summary>
        /// The css class for the progress bar. Defaults to <see cref="ToasterDefaults.Classes.ProgressBarClass"/>.
        /// </summary>
        public string ProgressBarClass { get; set; } = ToasterDefaults.Classes.ProgressBarClass;
        ...
        /// <summary>
        /// The css class for the close icon. Defaults to <see cref="ToasterDefaults.Classes.CloseIconClass"/>.
        /// </summary>
        public string CloseIconClass { get; set; } = ToasterDefaults.Classes.CloseIconClass;
